...
// Years
    ...
    function update2020_12() {
        ...
        d3.queue()
            ...
            .defer(d3.csv, "data/world_total_vaccinations_month.csv", function(d) {
                data.set(d.iso_code, +d['2020-12']) 
            })
            .await(draw);
